// $ANTLR 3.1.3 Mar 18, 2009 10:09:25 EvilTypeChecker.g 2010-06-09 19:23:12
...
public class EvilTypeChecker extends TreeParser {
        ...
        try {
            ...
            match(input, Token.UP, null); 
                     ...
                     if(!(ty.equals(fun.getReturn())))
                     {
                        ...
                        else if(ty instanceof TypeNull && fun.getReturn() instanceof TypeStruct)
                        {
                        }
                        else
                        {
    ...
    // EvilTypeChecker.g:190:1: parameters[State structs, State env, TypeFun fun] : ^( PARAMS (ty= decl[structs, env] )* ) ;
    public final void parameters(State structs, State env, TypeFun fun) throws RecognitionException {
        Type ty = null;


        try {
            // EvilTypeChecker.g:191:4: ( ^( PARAMS (ty= decl[structs, env] )* ) )
            // EvilTypeChecker.g:191:6: ^( PARAMS (ty= decl[structs, env] )* )
            {
            match(input,PARAMS,FOLLOW_PARAMS_in_parameters641); 

            if ( input.LA(1)==Token.DOWN ) {
                match(input, Token.DOWN, null); 
                // EvilTypeChecker.g:191:15: (ty= decl[structs, env] )*
                loop9:
                do {
                    int alt9=2;
                    ...
                    switch (alt9) {
                	case 1 :
                	    // EvilTypeChecker.g:191:16: ty= decl[structs, env]
                	    {
    ...
    // EvilTypeChecker.g:194:1: return_type[State structs] returns [Type t = null] : (ty= type[structs] | VOID );
    public final Type return_type(State structs) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:195:4: (ty= type[structs] | VOID )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // EvilTypeChecker.g:195:6: ty= type[structs]
                    {
    ...
    // EvilTypeChecker.g:199:1: statement[State structs, State env] returns [Type typ = new TypeVoid()] : (ty= block[structs, env] | assignment[structs, env] | print[structs, env] | read[structs, env] | ty= conditional[structs, env] | loop[structs, env] | delete[structs, env] | ty= ret[structs, env] | invocation[structs, env] );
    public final Type statement(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:200:4: (ty= block[structs, env] | assignment[structs, env] | print[structs, env] | read[structs, env] | ty= conditional[structs, env] | loop[structs, env] | delete[structs, env] | ty= ret[structs, env] | invocation[structs, env] )
            int alt11=9;
            switch ( input.LA(1) ) {
            case BLOCK:
                {
            ...
            switch (alt11) {
                case 1 :
                    // EvilTypeChecker.g:200:6: ty= block[structs, env]
                    {
                    ...
                    break;
                case 2 :
                    // EvilTypeChecker.g:204:6: assignment[structs, env]
                    {
                    ...
                    break;
                case 3 :
                    // EvilTypeChecker.g:208:6: print[structs, env]
                    {
                    ...
                    break;
                case 4 :
                    // EvilTypeChecker.g:212:6: read[structs, env]
                    {
                    ...
                    break;
                case 5 :
                    // EvilTypeChecker.g:216:6: ty= conditional[structs, env]
                    {
                    ...
                    break;
                case 6 :
                    // EvilTypeChecker.g:220:6: loop[structs, env]
                    {
                    ...
                    break;
                case 7 :
                    // EvilTypeChecker.g:224:6: delete[structs, env]
                    {
                    ...
                    break;
                case 8 :
                    // EvilTypeChecker.g:228:6: ty= ret[structs, env]
                    {
                    ...
                    break;
                case 9 :
                    // EvilTypeChecker.g:232:6: invocation[structs, env]
                    {
    ...
    // $ANTLR start "block"
    // EvilTypeChecker.g:238:1: block[State structs, State env] returns [Type typ = new TypeVoid()] : ^( BLOCK ty= statement_list[structs, env] ) ;
    public final Type block(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:239:4: ( ^( BLOCK ty= statement_list[structs, env] ) )
            // EvilTypeChecker.g:239:6: ^( BLOCK ty= statement_list[structs, env] )
            {
    ...
    // EvilTypeChecker.g:242:1: statement_list[State structs,State env] returns [Type typ = new TypeVoid()] : ^( STMTS (ty= statement[structs, env] )* ) ;
    public final Type statement_list(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:243:4: ( ^( STMTS (ty= statement[structs, env] )* ) )
            // EvilTypeChecker.g:243:6: ^( STMTS (ty= statement[structs, env] )* )
            {
            match(input,STMTS,FOLLOW_STMTS_in_statement_list872); 

            if ( input.LA(1)==Token.DOWN ) {
                match(input, Token.DOWN, null); 
                // EvilTypeChecker.g:243:16: (ty= statement[structs, env] )*
                loop12:
                do {
                    int alt12=2;
    ...
    // EvilTypeChecker.g:252:1: assignment[State structs, State env] : ^(as= ASSIGN rTy= expression[structs, env] lTy= lvalue[structs, env] ) ;
    public final void assignment(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:253:4: ( ^(as= ASSIGN rTy= expression[structs, env] lTy= lvalue[structs, env] ) )
            // EvilTypeChecker.g:253:6: ^(as= ASSIGN rTy= expression[structs, env] lTy= lvalue[structs, env] )
            {
            ...
            match(input, Token.UP, null); 
                     ...
                     if (!(rTy.equals(lTy)) && !(lTy instanceof TypeStruct && rTy instanceof TypeNull))
                     {
    ...
    // $ANTLR start "lvalue"
    // EvilTypeChecker.g:262:1: lvalue[State structs, State env] returns [Type ty = null] : (id= ID | ^( DOT temp= lvalue[structs, env] member= ID ) );
    public final Type lvalue(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:263:4: (id= ID | ^( DOT temp= lvalue[structs, env] member= ID ) )
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // EvilTypeChecker.g:268:6: ^( DOT temp= lvalue[structs, env] member= ID )
                    {
    ...
    // $ANTLR start "print"
    // EvilTypeChecker.g:310:1: print[State structs, State env] : ^(p= PRINT exp= expression[structs, env] ( ENDL )? ) ;
    public final void print(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:311:4: ( ^(p= PRINT exp= expression[structs, env] ( ENDL )? ) )
            // EvilTypeChecker.g:311:6: ^(p= PRINT exp= expression[structs, env] ( ENDL )? )
            {
    ...
    // $ANTLR start "read"
    // EvilTypeChecker.g:320:1: read[State structs, State env] : ^(r= READ l= lvalue[structs, env] ) ;
    public final void read(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:321:4: ( ^(r= READ l= lvalue[structs, env] ) )
            // EvilTypeChecker.g:321:6: ^(r= READ l= lvalue[structs, env] )
            {
    ...
    // EvilTypeChecker.g:330:1: conditional[State structs, State env] returns [Type ty = null] : ^(cond= IF guard= expression[structs, env] tp= block[structs, env] (typ= block[structs, env] )? ) ;
    public final Type conditional(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:331:4: ( ^(cond= IF guard= expression[structs, env] tp= block[structs, env] (typ= block[structs, env] )? ) )
            // EvilTypeChecker.g:331:6: ^(cond= IF guard= expression[structs, env] tp= block[structs, env] (typ= block[structs, env] )? )
            {
            ...
            // EvilTypeChecker.g:331:70: (typ= block[structs, env] )?
            int alt15=2;
            ...
            switch (alt15) {
                case 1 :
                    // EvilTypeChecker.g:331:71: typ= block[structs, env]
                    {
            ...
            match(input, Token.UP, null); 
                     ...
                     {
                        if (!(tp.equals(typ)) &&
                            (!(tp instanceof TypeNull && typ instanceof TypeStruct) && !(tp instanceof TypeStruct && typ instanceof TypeNull))
                           )
                        {
                           System.out.println(tp.toString() + "  " + typ.toString());
    ...
    // $ANTLR start "loop"
    // EvilTypeChecker.g:357:1: loop[State structs, State env] : ^(cond= WHILE guard1= expression[structs, env] block[structs, env] guard2= expression[structs, env] ) ;
    public final void loop(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:358:4: ( ^(cond= WHILE guard1= expression[structs, env] block[structs, env] guard2= expression[structs, env] ) )
            // EvilTypeChecker.g:358:6: ^(cond= WHILE guard1= expression[structs, env] block[structs, env] guard2= expression[structs, env] )
            {
    ...
    // $ANTLR start "delete"
    // EvilTypeChecker.g:372:1: delete[State structs, State env] : ^(d= DELETE exp= expression[structs, env] ) ;
    public final void delete(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:373:4: ( ^(d= DELETE exp= expression[structs, env] ) )
            // EvilTypeChecker.g:373:6: ^(d= DELETE exp= expression[structs, env] )
            {
    ...
    // $ANTLR start "ret"
    // EvilTypeChecker.g:382:1: ret[State structs, State env] returns [Type ty = null] : ^(r= RETURN (exp= expression[structs, env] )? ) ;
    public final Type ret(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:383:4: ( ^(r= RETURN (exp= expression[structs, env] )? ) )
            // EvilTypeChecker.g:383:6: ^(r= RETURN (exp= expression[structs, env] )? )
            {
            r=(CommonTree)match(input,RETURN,FOLLOW_RETURN_in_ret1202); 

            if ( input.LA(1)==Token.DOWN ) {
                match(input, Token.DOWN, null); 
                // EvilTypeChecker.g:383:17: (exp= expression[structs, env] )?
                int alt16=2;
                ...
                switch (alt16) {
                    case 1 :
                        // EvilTypeChecker.g:383:18: exp= expression[structs, env]
                        {
    ...
    // EvilTypeChecker.g:401:1: invocation[State structs, State env] : ^( INVOKE id= ID args= arguments[structs, env] invocation_help[structs, env, $id.text, args, $id.line] ) ;
    public final void invocation(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:402:4: ( ^( INVOKE id= ID args= arguments[structs, env] invocation_help[structs, env, $id.text, args, $id.line] ) )
            // EvilTypeChecker.g:402:6: ^( INVOKE id= ID args= arguments[structs, env] invocation_help[structs, env, $id.text, args, $id.line] )
            {
    ...
    // EvilTypeChecker.g:406:1: invocation_help[State structs, State env, String id, ArrayList<Type> gotArgs, int lineNum] returns [Type ty = null] : ;
    public final Type invocation_help(State structs, State env, String id, ArrayList<Type> gotArgs, int lineNum) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:407:4: ()
            // EvilTypeChecker.g:408:7: 
            {
    ...
    // EvilTypeChecker.g:451:1: expression[State structs, State env] returns [Type ty = null] : ( ^(op= ( AND | OR ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= ( EQ | NE ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= ( LT | GT | LE | GE ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= ( PLUS | MINUS ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= ( TIMES | DIVIDE ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= NOT operand= expression[structs, env] ) | ^(op= NEG operand= expression[structs, env] ) | ^(op= DOT operand= expression[structs, env] id= ID ) | ^( INVOKE id= ID gotArgs= arguments[structs, env] temp= invocation_help[structs, env, $id.text, gotArgs, $id.line] ) | id= ID | INTEGER | TRUE | FALSE | ^( NEW id= ID ) | NULL );
    public final Type expression(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:452:4: ( ^(op= ( AND | OR ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= ( EQ | NE ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= ( LT | GT | LE | GE ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= ( PLUS | MINUS ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= ( TIMES | DIVIDE ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= NOT operand= expression[structs, env] ) | ^(op= NEG operand= expression[structs, env] ) | ^(op= DOT operand= expression[structs, env] id= ID ) | ^( INVOKE id= ID gotArgs= arguments[structs, env] temp= invocation_help[structs, env, $id.text, gotArgs, $id.line] ) | id= ID | INTEGER | TRUE | FALSE | ^( NEW id= ID ) | NULL )
            int alt17=15;
            switch ( input.LA(1) ) {
            case AND:
            case OR:
            ...
            switch (alt17) {
                case 1 :
                    // EvilTypeChecker.g:452:6: ^(op= ( AND | OR ) left= expression[structs, env] right= expression[structs, env] )
                    {
                    ...
                    break;
                case 2 :
                    // EvilTypeChecker.g:460:6: ^(op= ( EQ | NE ) left= expression[structs, env] right= expression[structs, env] )
                    {
                    op=(CommonTree)input.LT(1);
                    ...
                    match(input, Token.UP, null); 
                            ...
                            if((left instanceof TypeStruct) && (right instanceof TypeNull))
                            {
                                return new TypeBool();
                            }
                            if((left instanceof TypeStruct) && (right instanceof TypeStruct))
                            {
                                return new TypeBool();
                            }
                            if((left instanceof TypeNull) && (right instanceof TypeStruct))
                            {
                                return new TypeBool();
                            }
                    ...
                    break;
                case 3 :
                    // EvilTypeChecker.g:480:6: ^(op= ( LT | GT | LE | GE ) left= expression[structs, env] right= expression[structs, env] )
                    {
                    op=(CommonTree)input.LT(1);
                    if ( (input.LA(1)>=LT && input.LA(1)<=GT)||(input.LA(1)>=LE && input.LA(1)<=GE) ) {
                        input.consume();
                        state.errorRecovery=false;
                    }
                    else {
                    ...
                    break;
                case 4 :
                    // EvilTypeChecker.g:488:6: ^(op= ( PLUS | MINUS ) left= expression[structs, env] right= expression[structs, env] )
                    {
                    op=(CommonTree)input.LT(1);
                    ...
                    break;
                case 5 :
                    // EvilTypeChecker.g:496:6: ^(op= ( TIMES | DIVIDE ) left= expression[structs, env] right= expression[structs, env] )
                    {
                    op=(CommonTree)input.LT(1);
                    ...
                    break;
                case 6 :
                    // EvilTypeChecker.g:504:6: ^(op= NOT operand= expression[structs, env] )
                    {
                    op=(CommonTree)match(input,NOT,FOLLOW_NOT_in_expression1489); 
                    ...
                    break;
                case 7 :
                    // EvilTypeChecker.g:512:6: ^(op= NEG operand= expression[structs, env] )
                    {
                    op=(CommonTree)match(input,NEG,FOLLOW_NEG_in_expression1513); 
                    ...
                    break;
                case 8 :
                    // EvilTypeChecker.g:520:6: ^(op= DOT operand= expression[structs, env] id= ID )
                    {
                    op=(CommonTree)match(input,DOT,FOLLOW_DOT_in_expression1537); 
                    ...
                    id=(CommonTree)match(input,ID,FOLLOW_ID_in_expression1546); 
                    ...
                    break;
                case 9 :
                    // EvilTypeChecker.g:535:6: ^( INVOKE id= ID gotArgs= arguments[structs, env] temp= invocation_help[structs, env, $id.text, gotArgs, $id.line] )
                    {
                    match(input,INVOKE,FOLLOW_INVOKE_in_expression1563); 

                    match(input, Token.DOWN, null); 
                    id=(CommonTree)match(input,ID,FOLLOW_ID_in_expression1567); 
                    pushFollow(FOLLOW_arguments_in_expression1571);
                    gotArgs=arguments(structs, env);

                    state._fsp--;

                    pushFollow(FOLLOW_invocation_help_in_expression1584);
                    ...
                    break;
                case 10 :
                    // EvilTypeChecker.g:541:6: id= ID
                    {
                    id=(CommonTree)match(input,ID,FOLLOW_ID_in_expression1611); 
                    ...
                    break;
                case 11 :
                    // EvilTypeChecker.g:550:6: INTEGER
                    {
                    match(input,INTEGER,FOLLOW_INTEGER_in_expression1626); 
                    ...
                    break;
                case 12 :
                    // EvilTypeChecker.g:554:6: TRUE
                    {
                    match(input,TRUE,FOLLOW_TRUE_in_expression1641); 
                    ...
                    break;
                case 13 :
                    // EvilTypeChecker.g:558:6: FALSE
                    {
                    match(input,FALSE,FOLLOW_FALSE_in_expression1656); 
                    ...
                    break;
                case 14 :
                    // EvilTypeChecker.g:562:6: ^( NEW id= ID )
                    {
                    match(input,NEW,FOLLOW_NEW_in_expression1672); 

                    match(input, Token.DOWN, null); 
                    id=(CommonTree)match(input,ID,FOLLOW_ID_in_expression1676); 
                    ...
                    break;
                case 15 :
                    // EvilTypeChecker.g:570:6: NULL
                    {
                    match(input,NULL,FOLLOW_NULL_in_expression1692); 
    ...
    // EvilTypeChecker.g:582:1: arguments[State structs, State env] returns [ArrayList<Type> args = new ArrayList<Type>()] : gotArgs= arg_list[structs, env] ;
    public final ArrayList<Type> arguments(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:583:4: (gotArgs= arg_list[structs, env] )
            // EvilTypeChecker.g:583:6: gotArgs= arg_list[structs, env]
            {
            pushFollow(FOLLOW_arg_list_in_arguments1725);
    ...
    // EvilTypeChecker.g:586:1: arg_list[State structs, State env] returns [ArrayList<Type> args = new ArrayList<Type>()] : ( ^( ARGS (exp= expression[structs, env] )+ ) | ARGS );
    public final ArrayList<Type> arg_list(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:587:4: ( ^( ARGS (exp= expression[structs, env] )+ ) | ARGS )
            int alt19=2;
            ...
            switch (alt19) {
                case 1 :
                    // EvilTypeChecker.g:587:6: ^( ARGS (exp= expression[structs, env] )+ )
                    {
                    match(input,ARGS,FOLLOW_ARGS_in_arg_list1749); 

                    match(input, Token.DOWN, null); 
                    // EvilTypeChecker.g:587:13: (exp= expression[structs, env] )+
                    int cnt18=0;
                    loop18:
                    do {
                        int alt18=2;
                        ...
                        switch (alt18) {
                    	case 1 :
                    	    // EvilTypeChecker.g:587:14: exp= expression[structs, env]
                    	    {
                    	    pushFollow(FOLLOW_expression_in_arg_list1754);
                    	    exp=expression(structs, env);
                    ...
                    break;
                case 2 :
                    // EvilTypeChecker.g:588:6: ARGS
                    {
                    match(input,ARGS,FOLLOW_ARGS_in_arg_list1767); 
    ...
    public static final BitSet FOLLOW_expression_in_expression1351 = new BitSet(new long[]{0x03FFFC05001E0000L});
    public static final BitSet FOLLOW_expression_in_expression1356 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_set_in_expression1376 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression1394 = new BitSet(new long[]{0x03FFFC05001E0000L});
    public static final BitSet FOLLOW_expression_in_expression1399 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_set_in_expression1419 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression1429 = new BitSet(new long[]{0x03FFFC05001E0000L});
    public static final BitSet FOLLOW_expression_in_expression1434 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_set_in_expression1454 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression1464 = new BitSet(new long[]{0x03FFFC05001E0000L});
    public static final BitSet FOLLOW_expression_in_expression1469 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NOT_in_expression1489 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression1493 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NEG_in_expression1513 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression1517 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_DOT_in_expression1537 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression1541 = new BitSet(new long[]{0x0100000000000000L});
    public static final BitSet FOLLOW_ID_in_expression1546 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_INVOKE_in_expression1563 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_ID_in_expression1567 = new BitSet(new long[]{0x0000000200000000L});
    public static final BitSet FOLLOW_arguments_in_expression1571 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_invocation_help_in_expression1584 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ID_in_expression1611 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_INTEGER_in_expression1626 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_TRUE_in_expression1641 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_FALSE_in_expression1656 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NEW_in_expression1672 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_ID_in_expression1676 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NULL_in_expression1692 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_arg_list_in_arguments1725 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ARGS_in_arg_list1749 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_arg_list1754 = new BitSet(new long[]{0x03FFFC05001E0008L});
    public static final BitSet FOLLOW_ARGS_in_arg_list1767 = new BitSet(new long[]{0x0000000000000002L});
