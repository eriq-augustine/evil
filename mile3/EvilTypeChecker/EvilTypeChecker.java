// $ANTLR 3.1.3 Mar 18, 2009 10:09:25 EvilTypeChecker.g 2010-04-30 09:03:29
...
public class EvilTypeChecker extends TreeParser {
    ...
    public final void assignment(State structs, State env) throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_lvalue_in_assignment919);
            ...
            match(input, Token.UP, null); 
                     ...
                     System.err.println("sdfgsdfgsdfgsdgsdf");
                     if (!(rTy.equals(lTy)))
                     {
    ...
    // $ANTLR start "lvalue"
    // EvilTypeChecker.g:260:1: lvalue[State structs, State env] returns [Type ty = null] : id= ID ( DOT member= ID )* ;
    public final Type lvalue(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:261:4: (id= ID ( DOT member= ID )* )
            // EvilTypeChecker.g:261:6: id= ID ( DOT member= ID )*
            {
            id=(CommonTree)match(input,ID,FOLLOW_ID_in_lvalue951); 
            ...
            // EvilTypeChecker.g:272:6: ( DOT member= ID )*
            loop13:
            do {
                int alt13=2;
                ...
                switch (alt13) {
            	case 1 :
            	    // EvilTypeChecker.g:272:7: DOT member= ID
            	    {
            	    match(input,DOT,FOLLOW_DOT_in_lvalue966); 
            	    member=(CommonTree)match(input,ID,FOLLOW_ID_in_lvalue970); 
    ...
    // $ANTLR start "print"
    // EvilTypeChecker.g:291:1: print[State structs, State env] : ^(p= PRINT exp= expression[structs, env] ( ENDL )? ) ;
    public final void print(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:292:4: ( ^(p= PRINT exp= expression[structs, env] ( ENDL )? ) )
            // EvilTypeChecker.g:292:6: ^(p= PRINT exp= expression[structs, env] ( ENDL )? )
            {
            p=(CommonTree)match(input,PRINT,FOLLOW_PRINT_in_print1005); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_expression_in_print1009);
            exp=expression(structs, env);

            state._fsp--;

            // EvilTypeChecker.g:292:45: ( ENDL )?
            int alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // EvilTypeChecker.g:292:46: ENDL
                    {
                    match(input,ENDL,FOLLOW_ENDL_in_print1013); 
    ...
    // $ANTLR start "read"
    // EvilTypeChecker.g:301:1: read[State structs, State env] : ^(r= READ l= lvalue[structs, env] ) ;
    public final void read(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:302:4: ( ^(r= READ l= lvalue[structs, env] ) )
            // EvilTypeChecker.g:302:6: ^(r= READ l= lvalue[structs, env] )
            {
            r=(CommonTree)match(input,READ,FOLLOW_READ_in_read1043); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_lvalue_in_read1047);
    ...
    // EvilTypeChecker.g:311:1: conditional[State structs, State env] returns [Type ty = null] : ^(cond= IF guard= expression[structs, env] tp= block[structs, env] (typ= block[structs, env] )? ) ;
    public final Type conditional(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:312:4: ( ^(cond= IF guard= expression[structs, env] tp= block[structs, env] (typ= block[structs, env] )? ) )
            // EvilTypeChecker.g:312:6: ^(cond= IF guard= expression[structs, env] tp= block[structs, env] (typ= block[structs, env] )? )
            {
            cond=(CommonTree)match(input,IF,FOLLOW_IF_in_conditional1080); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_expression_in_conditional1084);
            guard=expression(structs, env);

            state._fsp--;

            pushFollow(FOLLOW_block_in_conditional1089);
            tp=block(structs, env);

            state._fsp--;

            // EvilTypeChecker.g:312:70: (typ= block[structs, env] )?
            int alt15=2;
            ...
            switch (alt15) {
                case 1 :
                    // EvilTypeChecker.g:312:71: typ= block[structs, env]
                    {
                    pushFollow(FOLLOW_block_in_conditional1095);
    ...
    // $ANTLR start "loop"
    // EvilTypeChecker.g:335:1: loop[State structs, State env] : ^(cond= WHILE guard1= expression[structs, env] block[structs, env] guard2= expression[structs, env] ) ;
    public final void loop(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:336:4: ( ^(cond= WHILE guard1= expression[structs, env] block[structs, env] guard2= expression[structs, env] ) )
            // EvilTypeChecker.g:336:6: ^(cond= WHILE guard1= expression[structs, env] block[structs, env] guard2= expression[structs, env] )
            {
            cond=(CommonTree)match(input,WHILE,FOLLOW_WHILE_in_loop1126); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_expression_in_loop1130);
            guard1=expression(structs, env);

            state._fsp--;

            pushFollow(FOLLOW_block_in_loop1133);
            block(structs, env);

            state._fsp--;

            pushFollow(FOLLOW_expression_in_loop1138);
    ...
    // $ANTLR start "delete"
    // EvilTypeChecker.g:350:1: delete[State structs, State env] : ^(d= DELETE exp= expression[structs, env] ) ;
    public final void delete(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:351:4: ( ^(d= DELETE exp= expression[structs, env] ) )
            // EvilTypeChecker.g:351:6: ^(d= DELETE exp= expression[structs, env] )
            {
            d=(CommonTree)match(input,DELETE,FOLLOW_DELETE_in_delete1167); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_expression_in_delete1171);
            exp=expression(structs, env);
    ...
    // $ANTLR start "ret"
    // EvilTypeChecker.g:360:1: ret[State structs, State env] returns [Type ty = null] : ^(r= RETURN (exp= expression[structs, env] )? ) ;
    public final Type ret(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:361:4: ( ^(r= RETURN (exp= expression[structs, env] )? ) )
            // EvilTypeChecker.g:361:6: ^(r= RETURN (exp= expression[structs, env] )? )
            {
            r=(CommonTree)match(input,RETURN,FOLLOW_RETURN_in_ret1204); 

            if ( input.LA(1)==Token.DOWN ) {
                match(input, Token.DOWN, null); 
                // EvilTypeChecker.g:361:17: (exp= expression[structs, env] )?
                int alt16=2;
                ...
                switch (alt16) {
                    case 1 :
                        // EvilTypeChecker.g:361:18: exp= expression[structs, env]
                        {
                        pushFollow(FOLLOW_expression_in_ret1209);
                        exp=expression(structs, env);
    ...
    // EvilTypeChecker.g:379:1: invocation[State structs, State env] : ^( INVOKE id= ID args= arguments[structs, env] invocation_help[structs, env, $id.text, args, $id.line] ) ;
    public final void invocation(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:380:4: ( ^( INVOKE id= ID args= arguments[structs, env] invocation_help[structs, env, $id.text, args, $id.line] ) )
            // EvilTypeChecker.g:380:6: ^( INVOKE id= ID args= arguments[structs, env] invocation_help[structs, env, $id.text, args, $id.line] )
            {
            match(input,INVOKE,FOLLOW_INVOKE_in_invocation1239); 

            match(input, Token.DOWN, null); 
            id=(CommonTree)match(input,ID,FOLLOW_ID_in_invocation1243); 
            pushFollow(FOLLOW_arguments_in_invocation1247);
            args=arguments(structs, env);

            state._fsp--;

            pushFollow(FOLLOW_invocation_help_in_invocation1257);
    ...
    // EvilTypeChecker.g:384:1: invocation_help[State structs, State env, String id, ArrayList<Type> gotArgs, int lineNum] returns [Type ty = null] : ;
    public final Type invocation_help(State structs, State env, String id, ArrayList<Type> gotArgs, int lineNum) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:385:4: ()
            // EvilTypeChecker.g:386:7: 
            {
    ...
    public final Type expression(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:430:4: ( ^(op= ( AND | OR ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= ( EQ | LT | GT | NE | LE | GE ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= ( PLUS | MINUS ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= ( TIMES | DIVIDE ) left= expression[structs, env] right= expression[structs, env] ) | ^(op= NOT operand= expression[structs, env] ) | ^(op= NEG operand= expression[structs, env] ) | ^(op= DOT operand= expression[structs, env] id= ID ) | ^( INVOKE id= ID gotArgs= arguments[structs, env] temp= invocation_help[structs, env, $id.text, gotArgs, $id.line] ) | id= ID | INTEGER | TRUE | FALSE | ^( NEW id= ID ) | NULL )
            int alt17=14;
            switch ( input.LA(1) ) {
            case AND:
            case OR:
            ...
            switch (alt17) {
                case 1 :
                    // EvilTypeChecker.g:430:6: ^(op= ( AND | OR ) left= expression[structs, env] right= expression[structs, env] )
                    {
                    ...
                    break;
                case 2 :
                    // EvilTypeChecker.g:438:6: ^(op= ( EQ | LT | GT | NE | LE | GE ) left= expression[structs, env] right= expression[structs, env] )
                    {
                    op=(CommonTree)input.LT(1);
                    ...
                    break;
                case 3 :
                    // EvilTypeChecker.g:446:6: ^(op= ( PLUS | MINUS ) left= expression[structs, env] right= expression[structs, env] )
                    {
                    op=(CommonTree)input.LT(1);
                    ...
                    break;
                case 4 :
                    // EvilTypeChecker.g:454:6: ^(op= ( TIMES | DIVIDE ) left= expression[structs, env] right= expression[structs, env] )
                    {
                    op=(CommonTree)input.LT(1);
                    ...
                    pushFollow(FOLLOW_expression_in_expression1444);
                    right=expression(structs, env);
                    ...
                    break;
                case 5 :
                    // EvilTypeChecker.g:462:6: ^(op= NOT operand= expression[structs, env] )
                    {
                    op=(CommonTree)match(input,NOT,FOLLOW_NOT_in_expression1464); 
                    ...
                    break;
                case 6 :
                    // EvilTypeChecker.g:470:6: ^(op= NEG operand= expression[structs, env] )
                    {
                    op=(CommonTree)match(input,NEG,FOLLOW_NEG_in_expression1488); 
                    ...
                    break;
                case 7 :
                    // EvilTypeChecker.g:478:6: ^(op= DOT operand= expression[structs, env] id= ID )
                    {
                    op=(CommonTree)match(input,DOT,FOLLOW_DOT_in_expression1512); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_expression_in_expression1516);
                    operand=expression(structs, env);

                    state._fsp--;

                    id=(CommonTree)match(input,ID,FOLLOW_ID_in_expression1521); 
                    ...
                    break;
                case 8 :
                    // EvilTypeChecker.g:493:6: ^( INVOKE id= ID gotArgs= arguments[structs, env] temp= invocation_help[structs, env, $id.text, gotArgs, $id.line] )
                    {
                    match(input,INVOKE,FOLLOW_INVOKE_in_expression1538); 

                    match(input, Token.DOWN, null); 
                    id=(CommonTree)match(input,ID,FOLLOW_ID_in_expression1542); 
                    pushFollow(FOLLOW_arguments_in_expression1546);
                    gotArgs=arguments(structs, env);

                    state._fsp--;

                    pushFollow(FOLLOW_invocation_help_in_expression1559);
                    ...
                    break;
                case 9 :
                    // EvilTypeChecker.g:499:6: id= ID
                    {
                    id=(CommonTree)match(input,ID,FOLLOW_ID_in_expression1586); 
                    ...
                    break;
                case 10 :
                    // EvilTypeChecker.g:508:6: INTEGER
                    {
                    match(input,INTEGER,FOLLOW_INTEGER_in_expression1601); 
                    ...
                    break;
                case 11 :
                    // EvilTypeChecker.g:512:6: TRUE
                    {
                    match(input,TRUE,FOLLOW_TRUE_in_expression1616); 
                    ...
                    break;
                case 12 :
                    // EvilTypeChecker.g:516:6: FALSE
                    {
                    match(input,FALSE,FOLLOW_FALSE_in_expression1631); 
                    ...
                    break;
                case 13 :
                    // EvilTypeChecker.g:520:6: ^( NEW id= ID )
                    {
                    match(input,NEW,FOLLOW_NEW_in_expression1647); 

                    match(input, Token.DOWN, null); 
                    id=(CommonTree)match(input,ID,FOLLOW_ID_in_expression1651); 
                    ...
                    break;
                case 14 :
                    // EvilTypeChecker.g:528:6: NULL
                    {
                    match(input,NULL,FOLLOW_NULL_in_expression1667); 
    ...
    // EvilTypeChecker.g:540:1: arguments[State structs, State env] returns [ArrayList<Type> args = new ArrayList<Type>()] : gotArgs= arg_list[structs, env] ;
    public final ArrayList<Type> arguments(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:541:4: (gotArgs= arg_list[structs, env] )
            // EvilTypeChecker.g:541:6: gotArgs= arg_list[structs, env]
            {
            pushFollow(FOLLOW_arg_list_in_arguments1700);
    ...
    // EvilTypeChecker.g:544:1: arg_list[State structs, State env] returns [ArrayList<Type> args = new ArrayList<Type>()] : ( ^( ARGS (exp= expression[structs, env] )+ ) | ARGS );
    public final ArrayList<Type> arg_list(State structs, State env) throws RecognitionException {
        ...
        try {
            // EvilTypeChecker.g:545:4: ( ^( ARGS (exp= expression[structs, env] )+ ) | ARGS )
            int alt19=2;
            ...
            switch (alt19) {
                case 1 :
                    // EvilTypeChecker.g:545:6: ^( ARGS (exp= expression[structs, env] )+ )
                    {
                    match(input,ARGS,FOLLOW_ARGS_in_arg_list1724); 

                    match(input, Token.DOWN, null); 
                    // EvilTypeChecker.g:545:13: (exp= expression[structs, env] )+
                    int cnt18=0;
                    loop18:
                    do {
                        int alt18=2;
                        ...
                        switch (alt18) {
                    	case 1 :
                    	    // EvilTypeChecker.g:545:14: exp= expression[structs, env]
                    	    {
                    	    pushFollow(FOLLOW_expression_in_arg_list1729);
                    	    exp=expression(structs, env);
                    ...
                    break;
                case 2 :
                    // EvilTypeChecker.g:546:6: ARGS
                    {
                    match(input,ARGS,FOLLOW_ARGS_in_arg_list1742); 
    ...
    public static final BitSet FOLLOW_lvalue_in_assignment919 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ID_in_lvalue951 = new BitSet(new long[]{0x0000040000000002L});
    public static final BitSet FOLLOW_DOT_in_lvalue966 = new BitSet(new long[]{0x0100000000000000L});
    public static final BitSet FOLLOW_ID_in_lvalue970 = new BitSet(new long[]{0x0000040000000002L});
    public static final BitSet FOLLOW_PRINT_in_print1005 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_print1009 = new BitSet(new long[]{0x0000000000000408L});
    public static final BitSet FOLLOW_ENDL_in_print1013 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_READ_in_read1043 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_lvalue_in_read1047 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_IF_in_conditional1080 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_conditional1084 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_block_in_conditional1089 = new BitSet(new long[]{0x0000000040000008L});
    public static final BitSet FOLLOW_block_in_conditional1095 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_WHILE_in_loop1126 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_loop1130 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_block_in_loop1133 = new BitSet(new long[]{0x03FFFC05001E0000L});
    public static final BitSet FOLLOW_expression_in_loop1138 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_DELETE_in_delete1167 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_delete1171 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_RETURN_in_ret1204 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_ret1209 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_INVOKE_in_invocation1239 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_ID_in_invocation1243 = new BitSet(new long[]{0x0000000200000000L});
    public static final BitSet FOLLOW_arguments_in_invocation1247 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_invocation_help_in_invocation1257 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_set_in_expression1308 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression1318 = new BitSet(new long[]{0x03FFFC05001E0000L});
    public static final BitSet FOLLOW_expression_in_expression1323 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_set_in_expression1343 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression1369 = new BitSet(new long[]{0x03FFFC05001E0000L});
    public static final BitSet FOLLOW_expression_in_expression1374 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_set_in_expression1394 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression1404 = new BitSet(new long[]{0x03FFFC05001E0000L});
    public static final BitSet FOLLOW_expression_in_expression1409 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_set_in_expression1429 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression1439 = new BitSet(new long[]{0x03FFFC05001E0000L});
    public static final BitSet FOLLOW_expression_in_expression1444 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NOT_in_expression1464 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression1468 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NEG_in_expression1488 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression1492 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_DOT_in_expression1512 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression1516 = new BitSet(new long[]{0x0100000000000000L});
    public static final BitSet FOLLOW_ID_in_expression1521 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_INVOKE_in_expression1538 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_ID_in_expression1542 = new BitSet(new long[]{0x0000000200000000L});
    public static final BitSet FOLLOW_arguments_in_expression1546 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_invocation_help_in_expression1559 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ID_in_expression1586 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_INTEGER_in_expression1601 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_TRUE_in_expression1616 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_FALSE_in_expression1631 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NEW_in_expression1647 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_ID_in_expression1651 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NULL_in_expression1667 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_arg_list_in_arguments1700 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ARGS_in_arg_list1724 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_arg_list1729 = new BitSet(new long[]{0x03FFFC05001E0008L});
    public static final BitSet FOLLOW_ARGS_in_arg_list1742 = new BitSet(new long[]{0x0000000000000002L});
