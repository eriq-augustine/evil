...
public class Evil
{
   public static void main(String[] args)
   {
      ...
      try
      {
         ...
         evil.evilCFG.SymbolTable env = tparser.buildCFG(_debug);
         ...
         if (_dumpIL)
         {
            ...
            {
               System.err.println("Unable to make output stream for dumpIL");
            }

            System.out.println("Dumping ILOC to " + outFile);
            BasicBlock.dumpInstructions(myStream, env);
         }
      }
      catch (org.antlr.runtime.RecognitionException e)
      {
